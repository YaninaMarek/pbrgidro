...
<div>
   ...
   <div className='aboutText'>
      <p>  ООО «ПБР-ГИДРО» — лидер по бурению водных скважин в Республике Саха (Якутия). Компания образована в 2007 году и
         ...
         бурению гидрогеологических скважин в труднодоступных местах.
      </p>
      <p>   Основная база предприятия расположена в Ленском
         районе Республики Саха (Якутия), что закалило персонал при ведении работ в тяжёлых климатических условиях. 
      </p>
      <p>  Многолетний опыт и квалифицированные персонал позволят выполнять работы по полному комплексу обустройства месторождений
         водозаборными сооружениями, включая этапы проектирования, бурения, подсчёт запасав подземных вод, а так же постановка скважин на учёт. 
      </p>
